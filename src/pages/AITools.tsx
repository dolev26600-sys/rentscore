...
חשוב: תן מידע עובדתי בלבד. אל תייעץ "אל תחתום" או "הסעיף אסור". אמור "סעיפים מסוג זה אינם שכיחים".
החזר JSON בלבד: { "flags": [{ "clause": "שם הסעיף", "status": "red"|"yellow"|"green", "explanation": "הסבר עובדתי קצר בעברית" }] }
מקסימום 7 סעיפים.
